...
const RecipeCollection = () => {
  ...
  const GetDifficultyColor = (difficulty) => {
    switch (difficulty) {
      ...
      default:
        return "text-gray-600 bg-gary-100";
    }
  };
      ...
      <div className="max-w-4xl mx-auto ">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 ">
            {" "}
            find your fovarite recipe and star cooking!
          </p>
        </div>
        {/* catory filters */}
        <div className="flex justify-center gap-4 mb 8 flex-wrap">
          {categories.map((category) => (
            <button
              ...
              className={`px-4 py-4 rounded-full capitalize  cursor-pointer ${selectedCategory === category ? "bg-orange-500 text-gray-600" : "bg-white text-gray-600 hover:bg-orange-100"} `}
            >
              {category}
            </button>
          ))}
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-4 mb-4">
                  ...
                  <span
                    className={`text-sm px-2 py-1 rounded-full ${GetDifficultyColor(recipe.difficulty)}`}
                  >
                    {" "}
                    {recipe.difficulty}
                  </span>
